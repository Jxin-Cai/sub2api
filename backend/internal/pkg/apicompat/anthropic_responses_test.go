...
func TestAnthropicToResponses_SystemPrompt(t *testing.T) {
	t.Run("string", func(t *testing.T) {
		...
		// System prompt is now placed as developer role input item, not instructions.
...
func TestStreamingToolCall(t *testing.T) {
	...
	// 4. arguments done — closes the tool_use block
	events = ResponsesEventToAnthropicEvents(&ResponsesStreamEvent{
	...
	// 5. output_item.done — block already closed, no additional stop
	events = ResponsesEventToAnthropicEvents(&ResponsesStreamEvent{
