...
func (s *OpenAIGatewayService) FetchCodexModelsManifest(ctx context.Context, account *Account, clientVersion, ifNoneMatch string) (*CodexModelsManifest, error) {
	return fetchCodexModelsManifest(ctx, s, account, clientVersion, ifNoneMatch)
}

func fetchCodexModelsManifest(ctx context.Context, s *OpenAIGatewayService, account *Account, clientVersion, ifNoneMatch string) (*CodexModelsManifest, error) {
