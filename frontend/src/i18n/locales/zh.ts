export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dedup: '去重',
      dedupTitle: '账号去重',
      dedupHint: '扫描号池中名称重复的账号，保留最早创建的一条，删除其余重复项。',
      dedupScan: '开始扫描',
      dedupFoundSummary: '发现 {groups} 组重复账号，共 {total} 条将被删除',
      dedupColName: '账号名称',
      dedupColCount: '总数',
      dedupColRemove: '删除数',
      dedupNoDuplicates: '未发现重复账号',
      dedupConfirm: '确认删除',
      dedupExecuting: '删除中...',
      dedupResult: '去重完成，已删除 {removed} 条重复账号',
      dedupFailed: '去重操作失败',
      dataExport: '导出',
      ...
      dataImportSuccess: '导入完成：账号创建 {account_created}，跳过重名 {account_skipped}，失败 {account_failed}',
      dataImportCompletedWithErrors: '导入完成但有错误：账号失败 {account_failed}，代理失败 {proxy_failed}，跳过重名 {account_skipped}',
    ...
    usage: {
      ...
      cleanup: {
        ...
        retrySuccess: '清理任务已重新入队',
        retryFailed: '重试清理任务失败',
        recentTasks: '最近清理任务',
        loadingTasks: '正在加载任务...',
        noTasks: '暂无清理任务',
        range: '时间范围',
    ...
    settings: {
      ...
      site: {
        ...
        tablePageSizeOptionsHint: '使用英文逗号分隔，取值范围 5-5000，保存时会自动去重并排序',
