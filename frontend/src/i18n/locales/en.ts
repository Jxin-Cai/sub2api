export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dedup: 'Dedup',
      dedupTitle: 'Deduplicate Accounts',
      dedupHint: 'Scan for accounts with duplicate names. The earliest created account will be kept, and the rest will be removed.',
      dedupScan: 'Scan',
      dedupFoundSummary: 'Found {groups} groups of duplicates, {total} accounts will be removed',
      dedupColName: 'Account Name',
      dedupColCount: 'Total',
      dedupColRemove: 'To Remove',
      dedupNoDuplicates: 'No duplicate accounts found',
      dedupConfirm: 'Confirm Removal',
      dedupExecuting: 'Removing...',
      dedupResult: 'Dedup completed, {removed} duplicate accounts removed',
      dedupFailed: 'Dedup operation failed',
      dataExport: 'Export',
      ...
      dataImportSuccess: 'Import completed: accounts created {account_created}, skipped duplicates {account_skipped}, failed {account_failed}',
      dataImportCompletedWithErrors: 'Import completed with errors: account failed {account_failed}, proxy failed {proxy_failed}, skipped duplicates {account_skipped}',
    ...
    usage: {
      ...
      cleanup: {
        ...
        retrySuccess: 'Cleanup task queued again',
        retryFailed: 'Failed to retry cleanup task',
    ...
    settings: {
      ...
      site: {
        ...
        tablePageSizeOptionsHint: 'Use commas to separate integers between 5 and 5000; values are deduplicated and sorted on save',
