<template>
  <AppLayout>
    ...
    <DedupAccountsModal :show="showDedup" @close="showDedup = false" @deduped="reload" />
...
import DedupAccountsModal from '@/components/admin/account/DedupAccountsModal.vue'
